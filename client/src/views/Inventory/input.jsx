...
class InputProducts extends Component {
  ...
  onSelectProduct(_id) {
    ...
    this.setState({
      sku: this.state.productSearchResult.filter(x => x._id === _id)[0].sku
    });
  ...
  onInsertClick() {
    ...
    var product = this.state.productSearchResult.filter(
      x => x.sku === this.state.sku
    )[0];
